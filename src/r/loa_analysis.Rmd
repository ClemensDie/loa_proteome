...
data <- data[which((data$eos_abs < 1.3 & data$`disease severity` == "LN") | data$`disease severity` != "LN"), ]
data_adj <- data_adj[which((data_adj$eos_abs < 1.3 & data_adj$`disease severity` == "LN") | data_adj$`disease severity` != "LN"), ]
