...
## To Dos:
- Adapt ML to balancing
- Fix boxplots for most prominent markers
- Describe Sex comparison - chek regulated proteins
...
from utils.plotting import plot_volcano_limma, plot_fc_diff
...
Based on the observations in the previous section, we balance for age and sex 
when between INF and LN and within the severity groups. Furthermore 
we balanced for age within the severity groups. Code and documentation for 
...
plot_volcano_limma(limma_inf_ctrl, add_info="volcano_ctrl_inf",save_path=save_path_limma)
plot_volcano_limma(limma_mf_ew, add_info="volcano_mf_ew",save_path=save_path_limma)
# plot_volcano_limma(limma_mf_ew_rl, add_info="volcano_mf_ew",save_path=save_path_limma)
plot_volcano_limma(limma_mf_ewmf, add_info="volcano_mf_ewmf",save_path=save_path_limma)
# plot_volcano_limma(limma_mf_ewmf_rl, add_info="volcano_mf_ewmf_rl",save_path=save_path_limma)
plot_volcano_limma(limma_ew_ewmf, add_info="volcano_ew_ewmf",save_path=save_path_limma)
# plot_volcano_limma(limma_ew_ewmf_rl, add_info="volcano_ew_ewmf_rl",save_path=save_path_limma)
```
...
```{python}
pd.read_csv("data/analysis/loa/matched/data_matched_inf_ln.csv")
```
```{python}
# load matched data
...
protein_sel = [
    "P01861", "P01860", "P01871-2", "P07737", "P05543", "P00738", "P02766", "P01880;P01880-2", "O43866", "P13796", "A0A075B6K6"]
s = "infection"

data_matched_ln_inf = pd.read_csv("data/analysis/loa/matched/data_matched_inf_ln.csv")
...
```{python}
diff = plot_fc_diff(
    limma_mf_sex["logFC"],limma_ln_sex["logFC"],
    xlabel="MF (Women vs Men)",ylabel="LN (Women vs Men)", save_path=save_path_limma)
diff = plot_fc_diff(
    limma_ew_sex["logFC"],limma_ln_sex["logFC"],
    xlabel="EW (Women vs Men)",ylabel="LN (Women vs Men)", save_path=save_path_limma)
diff = plot_fc_diff(
    limma_ew_sex["logFC"],limma_mf_sex["logFC"],
    xlabel="EW (Women vs Men)",ylabel="MF (Women vs Men)", save_path=save_path_limma)
```
...
```{python}
limma_ln_sex = pd.read_csv("results/loaloa/tables/dea_limma/ln_sex.csv", index_col=0).loc[limma_inf_ctrl.index]
limma_mf_sex = pd.read_csv("results/loaloa/tables/dea_limma/mf_sex.csv", index_col=0).loc[limma_inf_ctrl.index]
limma_ew_sex = pd.read_csv("results/loaloa/tables/dea_limma/ew_sex.csv", index_col=0).loc[limma_inf_ctrl.index]
limma_ewmf_sex = pd.read_csv("results/loaloa/tables/dea_limma/ewmf_sex.csv", index_col=0).loc[limma_inf_ctrl.index]


plot_volcano_limma(limma_ln_sex, add_info="volcano_ln_sex",save_path=save_path_limma)
plot_volcano_limma(limma_mf_sex, add_info="volcano_mf_sex",save_path=save_path_limma)
plot_volcano_limma(limma_ew_sex , add_info="volcano_ew_sex",save_path=save_path_limma)
plot_volcano_limma(limma_ewmf_sex , add_info="volcano_ewmf_sex",save_path=save_path_limma)
...
meta_table_proteins = pd.read_csv(
    r"results/loaloa/tables/technical_meta_table.csv", index_col=0)
